---
title: kubernetes(八) Pod 控制器详解
date: 2023-06-25 09:22:36
permalink:  /kubernetes/607
sidebar: true
...
![](/assets/img/kubernetes/607/img.png)
...
![](/assets/img/kubernetes/607/img_1.png)
...
```
**镜像更新**
deployment支持两种更新策略:`重建更新（删掉所有老版本得pod，然后重建新版本的pod）`和`滚动更新（默认）（不会一次性删除，先删一部分低版本，建立一部分新版本，以此类推，直到满足数量）`,可以通过`strategy`指定策略类型,支持两个属性:
```yaml
...
![](/assets/img/kubernetes/607/img_2.png)

镜像更新中rs的变化，可以在创建镜像得时候加 --recode 参数，有助于记录创建过程等。
```shell
...
![](/assets/img/kubernetes/607/img_3.png)
...
![](/assets/img/kubernetes/607/img_4.png)
...
![](/assets/img/kubernetes/607/img_5.png)
...
![](/assets/img/kubernetes/607/img_6.png)
...
![](/assets/img/kubernetes/607/img_7.png)
